package com.offlinelabs.nutcracker.data.mapper
...
object FoodInfoMapper {
    ...
    fun mapToFoodInfo(response: OpenFoodFactsResponse, currentLanguage: com.offlinelabs.nutcracker.data.AppLanguage? = null): FoodInfo? {

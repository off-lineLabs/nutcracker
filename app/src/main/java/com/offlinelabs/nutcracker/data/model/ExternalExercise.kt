...
fun ExternalExercise.toInternalExercise(imagePaths: List<String> = emptyList()): Exercise {
    com.offlinelabs.nutcracker.util.logger.AppLogger.i("ExternalExercise", "toInternalExercise called:")
    com.offlinelabs.nutcracker.util.logger.AppLogger.i("ExternalExercise", "  - name: ${this.name}")
    com.offlinelabs.nutcracker.util.logger.AppLogger.i("ExternalExercise", "  - imagePaths parameter size: ${imagePaths.size}")
    imagePaths.forEachIndexed { index, path ->
        com.offlinelabs.nutcracker.util.logger.AppLogger.i("ExternalExercise", "    imagePath $index: $path")
    }
    ...
    com.offlinelabs.nutcracker.util.logger.AppLogger.i("ExternalExercise", "toInternalExercise created exercise:")
    com.offlinelabs.nutcracker.util.logger.AppLogger.i("ExternalExercise", "  - name: ${exercise.name}")
    com.offlinelabs.nutcracker.util.logger.AppLogger.i("ExternalExercise", "  - imagePaths.size: ${exercise.imagePaths.size}")

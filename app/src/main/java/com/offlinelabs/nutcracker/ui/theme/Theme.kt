...
fun FoodLogTheme(
    ...
    val colorScheme = when {
        darkTheme -> {
            com.offlinelabs.nutcracker.util.logger.AppLogger.d("FoodLogTheme", "Using custom dark colors: darkTheme=$darkTheme")
            DarkColorScheme
        }
        else -> {
            com.offlinelabs.nutcracker.util.logger.AppLogger.d("FoodLogTheme", "Using custom light colors: darkTheme=$darkTheme")
            LightColorScheme
        }
    }
